...
"""
Construct a ShrimpGIS CurveZ. Use it if you have z values.
    Args:
...
ghenv.Component.Name = "ShrimpGIS CurveZ"
ghenv.Component.NickName = "shrimp_curvez"
...
try:
    ...
    from shrimp_gis.geometry import ShpCurveZ
...
def main():
    ...
    if _curve:
        shp_curve = [ShpCurveZ(crv, num) for crv in _curve]
        for geo in shp_curve:
            geo.coordinates = get_latlon_from_location(geo.points, location, True)
