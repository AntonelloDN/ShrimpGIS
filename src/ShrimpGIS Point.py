...
ghenv.Component.Name = "ShrimpGIS Point"
ghenv.Component.NickName = "shrimp_point"
...
def main():
    ...
    if _point:
        shp_point = [ShpPoint(pt) for pt in _point]
        for pt in shp_point:
            pt.coordinates = get_latlon_from_location([pt.geometry], location)
